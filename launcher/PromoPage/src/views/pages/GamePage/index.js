...
import {Background, GameDescription, GameDetails} from '../../components';

import {View, Description} from '../../elements';

import {userSomeReq} from '../../../actions/users';
      ...
      <Background full>
        <View className="game-page">
          <View
            ...
            <img
              alt="homeback"
              className={`game-page__back_home__arrow${
                this.props.pageDirection === 'ltr' ? '' : '__rtl'
              }`}
