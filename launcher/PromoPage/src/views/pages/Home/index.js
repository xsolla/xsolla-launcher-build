...
import {Background, FeatucheringViewPager, LastUpdates, AllGames, NewGames} from '../../components';
      ...
      <Background>
        <View className="home">
          <View style={{flexDirection: 'row'}}>
            {window.publisher_logo ? (
              <img className="home__logo" src={window.publisher_logo} alt="" />
            ) : (
