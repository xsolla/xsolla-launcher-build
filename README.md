>**Info**: The latest Xsolla Launcher version is 2.14.3. If your Xsolla Launcher version is earlier than 2.6.0, please read [Wiki](https://github.com/xsolla/xsolla-launcher-build/wiki/New-version-of-Xsolla-Launcher-(v2.0.0)) to get updates.
